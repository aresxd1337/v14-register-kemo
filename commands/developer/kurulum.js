...
module.exports = {
    name: "kurulum",
    aliases: ['kanalkurulum' , "emojikurulum" , "kemokurulum" , "emoji-kurulum" , "kanal-kurulum" , "emojikur" , "kanalkur" , "emoji-kur" , "kanal-kur" , "kur"],
...
Gcen Süre: <t:${Math.floor(Date.now() / 1000)}:R>`, components: [row]})
            ...
            collector.on("collect", async interaction => {
              ...
              if (interaction.customId === "kanal") {
                ...
                const parent = await interaction.guild.channels.create("KEMO LOG'S", {
                  type: 'GUILD_CATEGORY',
